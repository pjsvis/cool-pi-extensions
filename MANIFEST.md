...
**[decisions/019-failover-ordering-policy.md](decisions/019-failover-ordering-policy.md)** — Decision 016 established that providers are a portfolio for failover + freebie capture, not a dedup graph — redundancy is resilience, not e…
