...
**[briefs/2026-07-23-brief-go-mermaid-renderer-01.md](briefs/2026-07-23-brief-go-mermaid-renderer-01.md)** — Extract the xAI `mermaid.rs` renderer from its `ratatui` dependency, compile it as a standalone CLI (`mermaid-tui`), and test whether it re…
